...
export { AUTO_INIT_KEY, byAttr2 as byAttr, coreHelpers, disposePattern, getNamespace, init, initPattern, isAutoInitEnabled, ready2 as ready, registerPattern, resetRegistry, setAutoInitFlag };
