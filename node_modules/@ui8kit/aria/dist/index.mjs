...
export { AUTO_INIT_KEY, accordion, alertPattern, byAttr2 as byAttr, combobox, coreHelpers, dialog, disclosure, disposePattern, getNamespace, init, initPattern, isAutoInitEnabled, listbox, menu, menubutton, ready2 as ready, registerPattern, resetRegistry, setAutoInitFlag, switchPattern, tabs, tooltip };
