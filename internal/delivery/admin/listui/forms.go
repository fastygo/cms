...
func BuildTaxonomyQuickEditForm(bundle adminfixtures.AdminFixture, state State, basePath string, token string, item domaintaxonomy.Definition) *blocks.InlineFormData {
	return &blocks.InlineFormData{
		...
		Fields: []blocks.FieldData{
			...
			{ID: "mode", Name: "mode", Label: bundle.Label("field_mode", "Mode"), Value: string(item.Mode), Component: "select", Options: []ui.FieldOption{{Value: "flat", Label: bundle.Label("mode_flat", "Flat")}, {Value: "hierarchical", Label: bundle.Label("mode_hierarchical", "Hierarchical")}}},
		},
		SubmitLabel: bundle.Label("action_save", "Save"),
		CancelLabel: bundle.Label("action_cancel", "Cancel"),
		CancelHref:  state.ReturnTo(basePath),
...
func BuildUserQuickEditForm(bundle adminfixtures.AdminFixture, state State, basePath string, token string, item domainusers.User) *blocks.InlineFormData {
	return &blocks.InlineFormData{
		Title:       bundle.Label("panel_quick_edit", "Quick edit"),
		Description: bundle.Label("panel_quick_edit_users_description", "Update profile fields, rotate passwords, issue recovery material, or create app tokens."),
		Action:      basePath,
		Method:      http.MethodPost,
		Token:       token,
		Fields: []blocks.FieldData{
			...
			{ID: "security_action", Name: "security_action", Label: bundle.Label("field_security_action", "Security action"), Value: "profile", Component: "select", Options: []ui.FieldOption{
				{Value: "profile", Label: bundle.Label("security_action_profile", "Update profile")},
				{Value: "set_password", Label: bundle.Label("security_action_set_password", "Set local password")},
				{Value: "generate_recovery_codes", Label: bundle.Label("security_action_generate_recovery_codes", "Generate recovery codes")},
				{Value: "issue_reset_token", Label: bundle.Label("security_action_issue_reset_token", "Issue reset token")},
				{Value: "create_app_token", Label: bundle.Label("security_action_create_app_token", "Create app token")},
				{Value: "revoke_app_token", Label: bundle.Label("security_action_revoke_app_token", "Revoke app token")},
			}},
			...
			{ID: "status", Name: "status", Label: bundle.Label("field_status", "Status"), Value: string(item.Status), Component: "select", Options: []ui.FieldOption{{Value: "active", Label: bundle.Label("status_user_active", "Active")}, {Value: "suspended", Label: bundle.Label("status_user_suspended", "Suspended")}, {Value: "deleted", Label: bundle.Label("status_user_deleted", "Deleted")}}},
			...
			{ID: "reset_token_label", Name: "reset_token_label", Label: bundle.Label("field_reset_token_label", "Reset token label"), Value: bundle.Label("default_user_reset_token_label", "Admin reset")},
			...
			{ID: "app_token_name", Name: "app_token_name", Label: bundle.Label("field_app_token_name", "App token name"), Value: bundle.Label("default_user_app_token_name", "API client")},
